...
- ⚡ Prefered tools: VSCode, Node, React, Webpack, Nextjs, Gatsby, Styled Components, Jest, Testing Library, Git, iTerm (please come to other OS), Docker and... well, any OS these days (even Windows!)
...
~ [PORTUGUÊS BRASILEIRO](README.md) ~ [ENGLISH](README_EN.md) ~ [ESPAÑOL](README_SP.md) ~
